Pod::Spec.new do |s|
  ...
  s.source = { :path => 'DevelopmentPods/SVGKit' }

  s.source_files = '*.{h,m}', '**/*.{h,m}'
  s.ios.exclude_files = 'AppKit additions/*.{h,m}', 'Exporters/SVGKExporterNSImage.{h,m}'
  s.tvos.exclude_files = 'AppKit additions/*.{h,m}', 'Exporters/SVGKExporterNSImage.{h,m}'
  s.osx.exclude_files = 'Exporters/SVGKExporterUIImage.{h,m}'
  s.libraries = 'xml2'
